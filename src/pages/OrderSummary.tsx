...
import { ChevronLeft, Check, Trash2, Trophy, MessageSquare } from 'lucide-react';
                ...
                <div key={order.id} className="border-b border-gray-200 pb-4 sm:pb-6 last:border-0">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="mt-3 relative">
                      ...
                      <textarea
                        value={suggestions[order.id] || ''}
                        onChange={(e) => handleSuggestionChange(order.id, e.target.value)}
